...
return {
    ...
    -- 生存之道
    {
        ...
        desc = {
            ...
            "最近我发现农作物也存在品质差异：普通、优秀、精良、杰出，甚至完美。种子的品质会传给长出的植株，收获物也会继承这份品质；如果长成了巨型作物，种子仍会保留品质，但蔬果会略微下降一级。",
            "烤熟并不会破坏蔬果品质，把蔬果喂给鸟笼里的鸟时吐出的种子也会记住它原本的品质。为了避免混淆，不同品质的同类物品不会自动堆到一起，拆分一叠物品时品质也会保留下来。",
            "更高品质的食物会让正面食用效果更强，同时削弱负面效果。每高一级大约会改变四分之一，所以一颗好种子可比看上去重要得多。",
        },
    },
