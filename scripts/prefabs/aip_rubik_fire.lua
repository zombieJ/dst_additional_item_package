...
local COLOUR_ENVELOPE_NAME_SMOKE = "aip_firesmokecolourenvelope"
local SCALE_ENVELOPE_NAME_SMOKE = "aip_firesmokescaleenvelope"
local COLOUR_ENVELOPE_NAME = "aip_firecolourenvelope"
local SCALE_ENVELOPE_NAME = "aip_firescaleenvelope"
...
return MakeTorchFire("aip_rubik_fire", assets, nil, common_postinit, master_postinit)
