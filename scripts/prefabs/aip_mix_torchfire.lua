...
local COLOUR_ENVELOPE_NAME_SMOKE = "aip_mix_torch_firesmokecolourenvelope"
local SCALE_ENVELOPE_NAME_SMOKE = "aip_mix_torch_firesmokescaleenvelope"
local COLOUR_ENVELOPE_NAME = "aip_mix_torch_firecolourenvelope"
local SCALE_ENVELOPE_NAME = "aip_mix_torch_firescaleenvelope"
...
local function InitEnvelope()
    ...
    EnvelopeManager:AddColourEnvelope(
        COLOUR_ENVELOPE_NAME,
        {
            ...
            -- 从外到里
            { 0,    IntColour(128, 0, 128, 128) },
            { .6,    IntColour(128, 0, 128, 64) },
            { .61,    IntColour(255, 255, 255, 64) },
...
return MakeTorchFire("aip_mix_torchfire", assets, nil, common_postinit, master_postinit)
